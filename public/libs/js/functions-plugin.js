...
jQuery(document).ready(function () {
    ...
    jQuery('a.merchant-team-member-det').click(function () {
        event.preventDefault();
    ...
    jQuery('#order_cancel, #id_order_truebtn, #id_order_falsebtn').click(function () {
        event.preventDefault();
        jQuery('#id_order_confrmdiv').toggle('fast');
    });
